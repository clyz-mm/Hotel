...
public class ListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException{//doGet方法
		doPost(req,res);//调用doPost方法
	}

	public void doPost(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		req.setCharacterEncoding("utf-8");//设置req编码为utf-8
		res.setCharacterEncoding("utf-8");//设置res编码为utf-8
		...
		String msg,String url)throws ServletException,IOException
		{
			...
			req.getRequestDispatcher(url).forward(req,res);//转发到消息页面
		}
}
